...
Properties:
   ...
   * `mipmaps` - Get/set the automatic generation of mipmaps for the image/artwork/video.
     ...
     the display driver settings if the Image with auto generated mipmaps is scaled
